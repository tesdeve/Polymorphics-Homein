...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { contactable_id: @contacto.contactable_id, contactable_type: @contacto.contactable_type, email: @contacto.email, telefono: @contacto.telefono } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { contactable_id: @contacto.contactable_id, contactable_type: @contacto.contactable_type, email: @contacto.email, telefono: @contacto.telefono } }
